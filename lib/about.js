define(function () {
  return function() {
    this.render = function (d) {
      ...
      s += "<p>Diese Installation des Meshviewers wird angeboten von "
      s += "<a href=\"https://freifunk-muensterland.de\">"
      s += "Freifunk Münsterland</a>.</p>"

      s += "<p>Mit Doppelklick und Shift+Doppelklick kann man in der Karte "
      s += "auch zoomen.</p>"

      s += "<h3>Lizenz: AGPL 3</h3>"
      ...
      s += "<p>This installation has been modified for the Freifunk Münsterland "
      s += "Community. You may find our modified project on "
      s += "<a href=\"https://github.com/FreiFunkMuenster/meshviewer/\">GitHub</a>.</p>"

      s += "<p>You may find the original source code at "
